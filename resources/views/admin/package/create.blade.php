...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h6 class="panel-title">ایجاد پکیج</h6>
        ...
        <div class="panel-body">
            {!! Form::open(['url'=>'admin/en/package','files'=>true,'class'=>'form-horizontal']) !!}
            <div class="row">
                <div class="col-md-3">
...
@section('footer')
    ...
    <script>
        $("div#demoupload").dropzone({
            url: "<?=url('admin/en/uploadimgpackage').'/'.\Session()->get(\Auth()->user()->email.'tmptime')?>",
            maxFilesize: 5,
            maxFile: 1,
            addRemoveLinks: true,
            dictRemoveFile: "حذف",
            ...
            init: function() {
                ...
                this.on("removedfile", function(file){
                    ...
                    $.ajax({
                        url: '<?= url('admin/en/deletimgpackage')  ?>',
                        type: "POST",
                        data:'nameimg='+file.name+'&packages_id='+ <?= \Session()->get(\Auth()->user()->email.'tmptime')  ?>,
